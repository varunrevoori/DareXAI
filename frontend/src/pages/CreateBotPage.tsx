...
export const CreateBotPage: React.FC = () => {
  ...
  const [voiceId, setVoiceId] = useState('xz64BitkNKshbyFO2E4V'); // Default to Varun
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Card>
          <CardHeader>
            <CardTitle>Create Voice Bot</CardTitle>
            <p className="text-gray-600 mt-2">Configure your AI voice assistant</p>
          </CardHeader>
          <CardContent>
